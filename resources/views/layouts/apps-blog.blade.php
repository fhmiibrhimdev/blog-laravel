...
<head>
    ...
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Inter&family=JetBrains+Mono&family=Roboto&display=swap');
    </style>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    @livewireStyles
</head>

<body class="layout-3" style="font-family: 'Roboto', sans-serif;">
    <div id="app">
